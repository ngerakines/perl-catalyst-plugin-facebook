# This Makefile is for the Catalyst::Plugin::Facebook extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Catalyst/Plugin/Facebook.pm]
#     AUTHOR => q[Nick Gerakines <nick@gerakines.net>]
#     NAME => q[Catalyst::Plugin::Facebook]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], WWW::Facebook::API=>q[0] }
#     VERSION_FROM => q[lib/Catalyst/Plugin/Facebook.pm]
#     clean => { FILES=>q[Catalyst-Plugin-Facebook-*] }
...
NAME_SYM = Catalyst_Plugin_Facebook
VERSION = 0.1
...
FULLEXT = Catalyst/Plugin/Facebook
BASEEXT = Facebook
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Catalyst/Plugin/Facebook.pm
...
TO_INST_PM = lib/Catalyst/Plugin/Facebook.pm

PM_TO_BLIB = lib/Catalyst/Plugin/Facebook.pm \
	blib/lib/Catalyst/Plugin/Facebook.pm
...
DISTVNAME = Catalyst-Plugin-Facebook-0.1
...
manifypods : pure_all  \
	lib/Catalyst/Plugin/Facebook.pm \
	lib/Catalyst/Plugin/Facebook.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Catalyst/Plugin/Facebook.pm $(INST_MAN3DIR)/Catalyst::Plugin::Facebook.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Catalyst-Plugin-Facebook' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.1' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Catalyst/Plugin/Facebook.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Build Facebook applications in Catalyst easier</ABSTRACT>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="WWW-Facebook-API" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Catalyst/Plugin/Facebook.pm blib/lib/Catalyst/Plugin/Facebook.pm 
